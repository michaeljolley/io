...
import { isMod, isBroadcaster } from 'io-shared/common';
...
export const helpCommand = (
  ...
  if (twitchChatFunc) {
    twitchChatFunc(
      `I can respond to the following commands: !attention, !blog, !candle, !discord, !font, !github, !heroines, !keyboard, !mark, !mod, !profile {github/twitter} {handle}, !project, !sfx, !so {user name}, !team, !theme, !twitter, !website, !youtube`
    );
    return true;
  }

...
const navItems = [
  ...
  { to: '/mcp',          name: 'mcp',           icon: '<path d="M10 2a8 8 0 1 0 0 16A8 8 0 0 0 10 2ZM3 10a7 7 0 0 1 11.95-4.95l-9.9 9.9A6.97 6.97 0 0 1 3 10Zm2.05 4.95 9.9-9.9A7 7 0 0 1 5.05 14.95Z"/>', label: 'MCP' },
]
